...
public class SuppliersDao {
    ...
    public boolean registerSupplierQuery(Suppliers supplier) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al registrar al proovedor");
            return false;
        }
    }
    ...
    public boolean updateSupplierQuery(Suppliers supplier) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al modificar los datos del proovedor");
            return false;
        }
    }
    ...
    public boolean deleteSupplierQuery(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No puedes eliminar un proveedor que tieen relacion con otra tabla");
            return false;
        }
    }
}
