...
public class EmployeesController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_employee) {
            ...
            if (row == -1) {
                ...
                int question = JOptionPane.showConfirmDialog(null, "Enrealidad quieres eliminar a este empleado");
            ...
            //Verificar que las cajas de texto estan vacias
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.employee_table) {
            ...
            views.cmb_rol.setSelectedItem(views.employee_table.getValueAt(row, 6).toString());
