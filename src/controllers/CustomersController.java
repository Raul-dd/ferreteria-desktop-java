    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_customer) {
            ...
            if (views.txt_customer_id.getText().equals("")
                ...
                JOptionPane.showMessageDialog(null, "Todos los campos son ibligatorios");
            } else {
            ...
            if (views.txt_customer_id.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Selecciona una fula para continuar");
            } else {
                if (views.txt_customer_id.getText().equals("")
                        || views.txt_customer_fullname.getText().equals("")
                        || views.txt_customer_address.getText().equals("")
                    ...
                    if (customerDao.updateCustomerQuery(customer)) {
                        ...
                        JOptionPane.showMessageDialog(null, "Datos del cleinte modificados con exito");
                    } else {
            ...
            if (row == -1) {
                ...
                int question = JOptionPane.showConfirmDialog(null, "¿Enrealidad quieres eliminar a este cliente?");
